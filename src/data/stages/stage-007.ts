...
export const STAGE_007: StageDefinition = {
  id: 'stage-007', name: '矢雨の回廊', chapterTitle: '第2章', description: 'arrow罠活用', width: 10, height: 8,
  tiles: [
  ...
  startPosition: { x: 1, y: 1 }, goalPosition: { x: 8, y: 1 }, heroId: 'adel', trapLimit: 6, initialTraps: [], chests: [{x:6,y:5}], tutorialHint: '罠の相性を試そう', narrativeId: 'stage-001'
};
