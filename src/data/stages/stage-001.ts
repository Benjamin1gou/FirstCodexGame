...
export const STAGE_001: StageDefinition = {
  id: 'stage-001', name: '誘惑の回廊', chapterTitle: '第1章', description: '基本ルール', width: 10, height: 8,
  tiles: [
  ...
  startPosition: { x: 1, y: 1 }, goalPosition: { x: 8, y: 1 }, heroId: 'adel', trapLimit: 5, initialTraps: [], chests: [], tutorialHint: 'クリックで罠を配置', narrativeId: 'stage-001'
};
