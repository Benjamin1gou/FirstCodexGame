...
export const STAGE_004: StageDefinition = {
  id: 'stage-004', name: '分岐の罠道', chapterTitle: '第2章', description: '複数ルート分岐', width: 10, height: 8,
  tiles: [
  ...
  startPosition: { x: 1, y: 1 }, goalPosition: { x: 8, y: 1 }, heroId: 'mio', trapLimit: 6, initialTraps: [], chests: [{x:6,y:5}], tutorialHint: '罠の相性を試そう', narrativeId: 'stage-001'
};
