...
export const STAGE_008: StageDefinition = {
  id: 'stage-008', name: '総合演習', chapterTitle: '第2章', description: '新罠総合試験', width: 10, height: 8,
  tiles: [
  ...
  startPosition: { x: 1, y: 1 }, goalPosition: { x: 8, y: 1 }, heroId: 'nia', trapLimit: 6, initialTraps: [], chests: [{x:6,y:5}], tutorialHint: '罠の相性を試そう', narrativeId: 'stage-001'
};
